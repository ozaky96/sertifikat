                ...
                <table class="table align-items-center mb-0">
                  ...
                  <?php
                    ...
                    <td class="text-center" style="vertical-align: middle;"><?= $row->assignment_id ?></td>
                        ...
                        <td>
                        <a href="<?= base_url('generate/download/' . $row->assignment_id);?>" class="btn btn-primary round btn-sm"><i data-feather="download"></i></a>
                        <a href="<?= base_url('generate/hapus_generate/' . $row->assignment_id); ?>" class="btn btn-danger round btn-sm"><i data-feather="trash"></i></a>
                    </tr>
                    <?php
                      }
                      ?>

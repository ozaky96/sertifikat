                  ...
                  <div class="card mb-5">
                    ...
                    <?= form_open_multipart('events/fungsi_edit_events'); ?>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="event_id"  placeholder=""  value="<?= $queryAllevents->event_id ?>" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="date" class="form-control" id="basic-default-name" name="event_date"   placeholder="" value="<?= $queryAllevents->event_date?>"/>
                          </div>
                        </div>
                        <div class="row mb-3">
